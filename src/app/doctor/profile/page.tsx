...
export default function DoctorProfilePage() {
  ...
  return (
    <div className="container mx-auto max-w-3xl px-4 py-10">
      <h1 className="mb-8 text-3xl font-bold">Doctor Profile</h1>
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <div className="space-y-4 rounded-lg border p-4">
          ...
          <div className="mt-4 flex items-center gap-4">
            <input
              type="checkbox"
              {...form.register("supportsInClinic")}
              id="clinic"
              className="h-4 w-4"
            />
        ...
        <div className="space-y-2">
          ...
          <textarea
            {...form.register("bio")}
            className="min-h-[100px] w-full rounded-md border border-slate-200 p-3 focus:ring-2 focus:ring-blue-500 focus:outline-none"
